...
```json
{
    ...
    "Credentials": {
        "SecretAccessKey": "9Wt68Dq9FDeEq6mkaCJrsKV1HiSk+Y+wIX13KsPi",
        "SessionToken": "",
        "Expiration": "2023-01-22T04:34:30Z",
        "AccessKeyId": "ASIA3QOD57M7NZOAFPAO"
    }
}
```
...
WITH (
  CREDENTIAL (
    AWS_ACCESS_KEY = 'ASIA3QOD57M7NZOAFPAO',
    AWS_SECRET_KEY = '9Wt68Dq9FDeEq6mkaCJrsKV1HiSk+Y+wIX13KsPi',
    AWS_SESSION_TOKEN = ''
    )
  )
)
FILEFORMAT = CSV
