...
#### AWS Session Token
```bash
aws iam create-access-key --user-name tdalpha
```
```json
{
    "AccessKey": {
        "UserName": "tdalpha",
        "AccessKeyId": "AKIA3QOD57M7P7DCDKCQ",
        "Status": "Active",
        "SecretAccessKey": "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",
        "CreateDate": "2023-03-18T19:10:47+00:00"
    }
}
```
```bash
aws sts assume-role --role-arn arn:aws:iam::791221762878:role/databricks-tpch-access-data-buckets --role-session-name "copyinto" --duration-seconds 43200 --profile jdolezal
```
```json
{
    "AssumedRoleUser": {
    ...
    "Credentials": {
        "SecretAccessKey": "cVohGNxHX0Bm7Icx4PcJDEIMjMclP6VaZpD1d+mv",
        "SessionToken": "",
        "Expiration": "2023-01-22T04:34:30Z",
        "AccessKeyId": "ASIA3QOD57M7HPSNARGG"
    }
}
```
...
WITH (
  CREDENTIAL (
    AWS_ACCESS_KEY = 'ASIA3QOD57M7HPSNARGG',
    AWS_SECRET_KEY = 'cVohGNxHX0Bm7Icx4PcJDEIMjMclP6VaZpD1d+mv',
    AWS_SESSION_TOKEN = ''
    )
  )
)
FILEFORMAT = CSV
